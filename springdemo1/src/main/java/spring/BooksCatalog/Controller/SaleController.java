...
import spring.BooksCatalog.Repo.SaleRepo;
import spring.BooksCatalog.Repo.SalesByTitleDTO;
import spring.BooksCatalog.Repo.StoreSumOfQtyDTO;
...
public class SaleController {
	...
	public List<SalesByTitleDTO> getSalesByTitle(@RequestParam("titleId") String titleId) {
